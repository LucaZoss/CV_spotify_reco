...
if st.session_state.page == 'upload':
    ...
    st.write("Upload an image from your device. The image should be in JPG, JPEG, or PNG format.")
...
if st.session_state.page == 'loading':
    ...
    with st.spinner("Analyzing emotions..."):
        ...
        for track in converted_output:
            print(f"Name: {track['name']}, Artist: {track['artist']}, Preview URL: {track['preview_url']}")
